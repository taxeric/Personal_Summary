...
public abstract class BaseAdapter {
    ...
    public interface ViewAdapter {
        ...
        <T extends View> T getView(int position);
    }
}
```
然后对FlowAdapter修改如下
```java
public class FlowAdapter implements BaseAdapter.ViewAdapter {
...
```java
    //设置适配器
    public void setAdapter(BaseAdapter.ViewAdapter adapter){
